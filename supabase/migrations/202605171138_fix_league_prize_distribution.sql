-- Migration: Fix FB League Prize Distribution Math
-- Description: Intelligently handles prize_distribution arrays with either percentages (sum <= 1.0) or absolute tokens (sum > 1.0).
