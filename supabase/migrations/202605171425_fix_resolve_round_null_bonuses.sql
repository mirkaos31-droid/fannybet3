-- Migration: Fix FB League Round Resolution Null Bonuses Error
-- Description: Prevents jsonb_array_elements_text from throwing on null values by wrapping the query in COALESCE and adding a guard clause.
...
BEGIN
    ...
    -- Allow CLOSED or ARCHIVED matchdays
